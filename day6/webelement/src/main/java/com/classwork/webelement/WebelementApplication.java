package com.classwork.webelement;
...
public class WebelementApplication {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// WebDriver driverchrome=new EdgeDriver();
		// driverchrome.get("https://economictimes.indiatimes.com/");
		
		// driverchrome.manage().window().maximize();
		// driverchrome.findElement(By.xpath("//*[@id='topnav']/div[10]/a")).click();
		
		// WebElement dropdown=driverchrome.findElement(By.id("amcSelection"));
		...
		SpringApplication.run(WebelementApplication.class, args);
	}
